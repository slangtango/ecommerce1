	...
	<div class="footer">
		<div id="footer_wrap">
			<div id="company_info">
				...
				<p>We have been in business for over 20 years, providing our customers the lowest possible prices for their sewing supplies. 					
					Products in the online catalog are available to the public, however we do add a small order charge to all orders under 							
					$125.00 Internet Sales Only</p>
			...
			<div id="contact_info">
				...
				<p>John Hittle
					...
					11703 Pierce Way
					<br>
					Louisville, KY 40272-5062
				</p>
				<p>
					Phone: 502-937-1503
				<p>
				<p>	
				Call Toll Free 1-877-805-2616    --     9 AM To 5 PM EST
				</p>
			</div>
		</div>
	</div>
